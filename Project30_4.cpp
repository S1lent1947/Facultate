...
public:
	...
	friend ofstream& operator<<(ofstream& of, const Produs& p)
	{
		of << " " << p.cod;
		of << " " << p.nume;
		of << " " << p.pret << endl;
...
public:
	...
	friend ofstream& operator<<(ofstream& of, const Tricou& p)
	{
		of << " " << p.cod;
		of << " " << p.nume;
		of << " " << p.pret <<endl;
...
public:
	...
	friend ofstream& operator<<(ofstream& of, const Pantaloni& p)
	{
		of << " " << p.cod;
		of << " " << p.nume;
		of << " " << p.pret << endl;
...
public:
	...
	friend ofstream& operator<<(ofstream& of, const Jacheta& p)
	{
		of << " " << p.cod;
		of << " " << p.nume;
		of << " " << p.pret << endl;
...
public:
	...
	friend ofstream& operator<<(ofstream& of, const Magazin& m)
	{
		for (auto& mi : m.produse)
			of << *mi << endl;
		for (auto m : m.vanzariMarimi)
			of << m.first << m.second << endl;
		return of;
	}
...
int main()
{
	...
	//cout << m1;
	//ofstream fout;
	//fout.open("TataiaBilosul.txt", ofstream::out);
	//if (fout.is_open())
	//{
	//	fout << m1;
	//	fout.close();
